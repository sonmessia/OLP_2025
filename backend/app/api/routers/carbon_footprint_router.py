...
async def get_carbon_footprint_by_id(
    ...
    try:
        return CarbonFootprintService.get_entity_by_id(
            entity_id, local=local, attrs=attrs
        )
    except httpx.HTTPError as e:
        raise HTTPException(status_code=getattr(e.response, 'status_code', 500), detail=str(e))
...
async def create_carbon_footprint(
    ...
    try:
        return CarbonFootprintService.create_entity(entity_data, local=local)
    except httpx.HTTPError as e:
        raise HTTPException(status_code=getattr(e.response, 'status_code', 500), detail=str(e))
...
async def update_carbon_footprint_attributes(
    ...
    try:
        return CarbonFootprintService.update_entity_attributes(
...
async def replace_carbon_footprint(
    ...
    try:
        return CarbonFootprintService.replace_entity(
            entity_id, entity_data, local=local
        )
    except httpx.HTTPError as e:
        raise HTTPException(status_code=getattr(e.response, 'status_code', 500), detail=str(e))
...
async def add_carbon_footprint_attributes(
    entity_id: str,
    attributes_data: Dict[str, Any],
    local: bool = Query(True, description="Add to local entity"),
):
    try:
        return CarbonFootprintService.add_attributes(
...
async def get_carbon_footprint_attribute(
    entity_id: str,
    attr_name: str,
    local: bool = Query(True, description="Get from local entity"),
):
    try:
        return CarbonFootprintService.get_attribute_by_id(
...
async def update_carbon_footprint_attribute(
    entity_id: str,
    attr_name: str,
    ...
    try:
        return CarbonFootprintService.update_attribute(
...
async def delete_carbon_footprint_attribute(
    entity_id: str,
    attr_name: str,
    local: bool = Query(True, description="Delete from local entity"),
):
    try:
        return CarbonFootprintService.delete_attribute(
            entity_id, attr_name, local=local
        )
    except httpx.HTTPError as e:
        raise HTTPException(status_code=getattr(e.response, 'status_code', 500), detail=str(e))
...
async def delete_carbon_footprint(
    entity_id: str, local: bool = Query(True, description="Delete local entity")
):
    try:
        return CarbonFootprintService.delete_entity(entity_id, local=local)
    except httpx.HTTPError as e:
        raise HTTPException(status_code=getattr(e.response, 'status_code', 500), detail=str(e))
