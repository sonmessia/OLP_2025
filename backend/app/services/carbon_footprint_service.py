...
class CarbonFootprintService(BaseService):
    ...
    async def get_all(self, **kwargs) -> Union[List[Dict[str, Any]], int]:
        """
        Queries for CarbonFootprint entities.
        It automatically adds the 'type=CarbonFootprint' filter to all queries.
        """
    ...
    async def batch_upsert(
        ...
        """
        Creates or updates a list of CarbonFootprint entities.
