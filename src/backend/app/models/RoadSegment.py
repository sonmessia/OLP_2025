...
class RoadSegment(BaseModel):
    ...
    endKilometer: Optional[float] = Field(
        None,
    ...
    length: Optional[float] = Field(
        None, description="Total length of this road segment in kilometers", ge=0.0
    )
    location: Optional[
    ...
    maximumAllowedHeight: Optional[float] = Field(
        None,
        description="Maximum allowed height for vehicles transiting this road segment",
        ge=0.0,
    )
    maximumAllowedSpeed: Optional[float] = Field(
        None,
    ...
    maximumAllowedWeight: Optional[float] = Field(
        None,
    ...
    minimumAllowedSpeed: Optional[float] = Field(
        None,
    ...
    startKilometer: Optional[float] = Field(
        None,
    ...
    totalLaneNumber: Optional[float] = Field(
        None, description="Total number of lanes offered by this road segment", ge=0.0
    )
    ...
    width: Optional[float] = Field(None, description="Road's segment width.", ge=0.0)
