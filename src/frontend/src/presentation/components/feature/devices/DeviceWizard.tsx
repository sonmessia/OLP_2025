...
export const DeviceWizard: React.FC<DeviceWizardProps> = ({
  ...
  const [connectionTest, setConnectionTest] = useState<ConnectionTestResult>('idle')
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="bg-white dark:bg-gray-900 w-full max-w-4xl h-[90vh] flex flex-col rounded-3xl border border-gray-200 dark:border-gray-700 shadow-2xl">
        {/* Header */}
        <div className="p-6 border-b border-gray-200 dark:border-gray-700 flex-shrink-0">
          <div className="flex items-center justify-between">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white">
              {editingDevice ? t('devices:wizard.title.edit') : t('devices:wizard.title.add')}
            </h2>
            <button
              onClick={onClose}
          ...
          <div className="mt-6 flex items-center justify-between">
            {(['type', 'connection', 'location', 'confirm'] as WizardStep[]).map((step) => (
              ...
              <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-greenwave-primary-light"
                        placeholder={t('devices:wizard.placeholders.manufacturer')}
                      />
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-gray-500 dark:text-gray-400 mb-2">
                      ...
                      >
                        ...
                        <option value={ConnectionProtocol.MODBUS_TCP}>Modbus TCP</option>
                      </select>
                    </div>
                  </div>
                </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-greenwave-primary-light"
                          placeholder={t('devices:wizard.placeholders.brokerUrl')}
                        />
                      </div>
                      <div>
                        <label className="block text-sm font-medium text-gray-500 dark:text-gray-400 mb-2">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-greenwave-primary-light"
                          placeholder={t('devices:wizard.placeholders.topicSubscribe')}
                        />
                      </div>
                      <div>
                        <label className="block text-sm font-medium text-gray-500 dark:text-gray-400 mb-2">
                        ...
                        <input
                          ...
                          className="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-greenwave-primary-light"
                          placeholder={t('devices:wizard.placeholders.topicPublish')}
                        />
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-greenwave-primary-light"
                          placeholder={t('devices:wizard.placeholders.ipAddress')}
                        />
                      </div>
                      <div>
                        <label className="block text-sm font-medium text-gray-500 dark:text-gray-400 mb-2">
                ...
                <div className="p-4 rounded-lg bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700">
                  <div className="flex items-center justify-between">
                    ...
                    >
                      {connectionTest === 'testing' && <Loader className="w-4 h-4 animate-spin" />}
                      {connectionTest === 'success' && <CheckCircle className="w-4 h-4" />}
                      {connectionTest === 'error' && <AlertCircle className="w-4 h-4" />}
                      {connectionTest === 'idle' && <Wifi className="w-4 h-4" />}
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-greenwave-primary-light"
                        placeholder={t('devices:wizard.placeholders.locationDesc')}
                        rows={3}
                      />
                    </div>
                  </div>
                ...
                <div>
                  ...
                  <div className="p-4 rounded-lg border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-800/50 h-64 flex items-center justify-center">
                    <p className="text-gray-500 dark:text-gray-400 text-center">
                      ...
                      <br />
                      <span className="text-sm">{t('devices:wizard.labels.dragPin')}</span>
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="p-6 rounded-lg bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <p className="font-medium text-gray-900 dark:text-white">{deviceData.name}</p>
                    </div>
                    <div>
                      <span className="text-sm text-gray-500 dark:text-gray-400">
                        {t('devices:wizard.steps.type')}:
                      </span>
                      <p className="font-medium text-gray-900 dark:text-white">{deviceData.type}</p>
                    </div>
                    <div>
                      <span className="text-sm text-gray-500 dark:text-gray-400">
                        {t('devices:wizard.labels.serial')}:
        ...
        {/* Footer */}
        <div className="p-6 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 flex justify-between flex-shrink-0">
          <button
