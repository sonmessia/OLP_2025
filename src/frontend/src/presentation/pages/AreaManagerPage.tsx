// src/presentation/pages/AreaManagerPage.tsx
        ...
        <div className="px-4 py-6 sm:px-0">
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="bg-white overflow-hidden shadow rounded-lg">
              ...
              <div className="bg-gray-50 px-5 py-3">
                <div className="text-sm">
                  <span className="text-green-600 font-medium">85%</span> thời
                  gian thông suốt
                </div>
              </div>
            </div>
            ...
            <div className="bg-white overflow-hidden shadow rounded-lg">
              ...
              <div className="bg-gray-50 px-5 py-3">
                <div className="text-sm">
                  <span className="text-yellow-600 font-medium">3</span> đèn
                  đang bảo trì
                </div>
              </div>
            </div>
            ...
            <div className="bg-white overflow-hidden shadow rounded-lg">
              ...
              <div className="bg-gray-50 px-5 py-3">
                <div className="text-sm">
                  <span className="text-red-600 font-medium">1</span> sự cố
                  nghiêm trọng
                </div>
              </div>
            </div>
            ...
            <div className="bg-white shadow rounded-lg">
              <div className="px-4 py-5 sm:p-6">
                <h3 className="text-lg leading-6 font-medium text-gray-900 mb-4">
                  Hoạt động gần đây tại {user.areaName}
                </h3>
                          ...
                          <div className="min-w-0 flex-1 pt-1.5 flex justify-between space-x-4">
                            <div>
                              <p className="text-sm text-gray-800">
                                Đèn tín hiệu tại ngã tư X đã được khôi phục hoạt
                                động
                              </p>
                            </div>
                      ...
                      <div className="relative pb-8">
                        <div className="relative flex space-x-3">
                          ...
                          <div className="min-w-0 flex-1 pt-1.5 flex justify-between space-x-4">
                            <div>
                              <p className="text-sm text-gray-800">
                                Phát hiện ùn tắc giao thông trên đường Y
                              </p>
                            </div>
                            <div className="text-right text-sm whitespace-nowrap text-gray-500">
                              25 phút trước
                      ...
                      <div className="relative">
                        <div className="relative flex space-x-3">
                          ...
                          <div className="min-w-0 flex-1 pt-1.5 flex justify-between space-x-4">
                            <div>
                              <p className="text-sm text-gray-800">
                                Báo cáo từ người dân về tai nạn giao thông
                              </p>
                            </div>
                            <div className="text-right text-sm whitespace-nowrap text-gray-500">
                              1 giờ trước
